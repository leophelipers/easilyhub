...
import CookieNoticeOesterreich from '@/app/(unprotected)/_components/cookiesaustria/CookiesAustria'
  ...
  return (
    <div className='relative h-screen w-full bg-[url("/ultravix.png")] bg-cover bg-center'>
      ...
      <div className="relative z-10 flex justify-center items-center h-full text-white text-2xl">
        <CookieNoticeOesterreich iframeSrc="https://at.urogun.com/?utm_source=216913" />
      </div>
    </div>
  )
}
