...
'use client'
// export interface IPrivacyPoliticesProps {} props: IAdminTopbarProps

export default function PrivacyPolitices() {
  return (
    <div>
      <p>
        Política PrivacidadeA sua privacidade é importante para nós. É política
        do EasilyHub respeitar a sua privacidade em relação a qualquer
        informação sua que possamos coletar no site EasilyHub, e outros sites
        que possuímos e operamos.Solicitamos informações pessoais apenas quando
        ...
        serviços desejados.O uso continuado de nosso site será considerado como
        ...
        pode fornecê-lo para fazer uma compra.Compromisso do UsuárioO usuário se
        compromete a fazer uso adequado dos conteúdos e da informação que o
        EasilyHub oferece no site e com caráter enunciativo, mas não
        ...
        conteúdo de natureza racista, xenofóbica, Bet Nacional ou azar, qualquer
        tipo de pornografia ilegal, de apologia ao terrorismo ou contra os
        direitos humanos;C) Não causar danos aos sistemas físicos (hardwares) e
        lógicos (softwares) do EasilyHub, de seus fornecedores ou terceiros,
        ...
        anteriormente mencionados.Mais informaçõesEsperemos que esteja
        esclarecido e, como mencionado anteriormente, se houver algo que você
        não tem certeza se precisa ou não, geralmente é mais seguro deixar os
        cookies ativados, caso interaja com um dos recursos que você usa em
        nosso site.Esta política é efetiva a partir de 9 October 2024 19:25
      </p>
    </div>
  )
}
